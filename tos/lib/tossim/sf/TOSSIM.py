...
class SerialPacket(_object):
    ...
    __del__ = lambda self : None;
    def setDestination(self):
        return _TOSSIM.SerialPacket_setDestination(*self)
    def destination(self):
        return _TOSSIM.SerialPacket_destination(*self)
    def setLength(self):
        return _TOSSIM.SerialPacket_setLength(*self)
    def length(self):
        return _TOSSIM.SerialPacket_length(*self)
    def setType(self):
        return _TOSSIM.SerialPacket_setType(*self)
    def type(self):
        return _TOSSIM.SerialPacket_type(*self)
    def data(self):
        return _TOSSIM.SerialPacket_data(*self)
    def setData(self):
        return _TOSSIM.SerialPacket_setData(*self)
    def maxLength(self):
        return _TOSSIM.SerialPacket_maxLength(*self)
    def deliver(self):
        return _TOSSIM.SerialPacket_deliver(*self)
    def deliverNow(self):
        return _TOSSIM.SerialPacket_deliverNow(*self)
...
class SerialForwarder(_object):
    ...
    __del__ = lambda self : None;
    def process(self):
        return _TOSSIM.SerialForwarder_process(*self)
    def dispatchPacket(self):
        return _TOSSIM.SerialForwarder_dispatchPacket(*self)
    def forwardPacket(self):
        return _TOSSIM.SerialForwarder_forwardPacket(*self)
...
class Throttle(_object):
    ...
    __del__ = lambda self : None;
    def initialize(self):
        return _TOSSIM.Throttle_initialize(*self)
    def finalize(self):
        return _TOSSIM.Throttle_finalize(*self)
    def checkThrottle(self):
        return _TOSSIM.Throttle_checkThrottle(*self)
    def printStatistics(self):
        return _TOSSIM.Throttle_printStatistics(*self)
...
class Tossim(_object):
    ...
    def newSerialPacket(self):
        return _TOSSIM.Tossim_newSerialPacket(*self)
