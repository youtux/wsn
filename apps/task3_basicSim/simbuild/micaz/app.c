...
# 23 "/usr/include/i386-linux-gnu/bits/sigset.h" 3
...
# 31 "/usr/include/i386-linux-gnu/sys/sysmacros.h" 3
__extension__ 
...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x403b6900, const void *arg_0x403b6a98);
#line 775
__extension__ 
#line 792
__extension__ 
...
#line 251
extern double erfc(double arg_0x40405b68) __attribute((__leaf__)) __attribute((__nothrow__)) ;
...
# 65 "/opt/tinyos/tos/lib/tossim/tos.h"
...
# 51 "/opt/tinyos/tos/lib/tossim/sim_tossim.h"
...
# 50 "/opt/tinyos/tos/lib/tossim/sim_event_queue.h"
struct sim_event;
...
# 53 "/opt/tinyos/tos/lib/tossim/sim_mote.h"
...
# 65 "/opt/tinyos/tos/lib/tossim/sim_log.h"
...
# 97 "/opt/tinyos/tos/lib/tossim/tos.h"
...
# 9 "/opt/tinyos/tos/lib/tossim/hashtable.h"
struct hashtable;
typedef struct hashtable hashtable_t;
#line 78
struct hashtable *
create_hashtable(unsigned int minsize, 
unsigned int (*hashfunction)(void *arg_0x4055b940), 
int (*key_eq_fn)(void *arg_0x4055bd88, void *arg_0x4055bf00));
#line 103
#line 102
int 
...
# 47 "/opt/tinyos/tos/lib/tossim/sim_log.c"
...
inline static int sim_log_eq(void *key1, void *key2);
# 65 "/opt/tinyos/tos/lib/tossim/heap.h"
#line 61
typedef struct heap {
  int size;
  void *data;
...
# 58 "/opt/tinyos/tos/lib/tossim/heap.c"
...
#line 197
static void up_heap(heap_t *heap, int findex);
# 44 "/opt/tinyos/tos/lib/tossim/sim_event_queue.c"
...
# 56 "/usr/include/i386-linux-gnu/sys/time.h" 3
struct timezone {
...
# 51 "/opt/tinyos/tos/lib/tossim/sim_noise.h"
...
# 51 "/opt/tinyos/tos/lib/tossim/sim_tossim.c"
...
bool sim_remove_channel(char *channel, FILE *file)   ;
# 99 "/opt/tinyos/tos/lib/tossim/sim_csma.h"
...
# 44 "/opt/tinyos/tos/lib/tossim/sim_csma.c"
...
void sim_csma_set_ack_time(int val)   ;
# 57 "/opt/tinyos/tos/lib/tossim/sim_gain.h"
#line 53
...
# 6 "/opt/tinyos/tos/lib/tossim/sim_gain.c"
#line 3
...
double sim_gain_sensitivity()   ;
# 39 "/opt/tinyos/tos/lib/tossim/randomlib.c"
...
static inline void RandomInitialise(int arg_0x406909b8, int arg_0x40690b10);
static double RandomUniform(void );
...
#line 419
void makeNoiseModel(uint16_t node_id)   ;
# 59 "/opt/tinyos/tos/lib/tossim/sim_packet.h"
...
# 12 "/opt/tinyos/tos/lib/tossim/TossimRadioMsg.h"
#line 6
...
# 53 "/opt/tinyos/tos/lib/tossim/platform_message.h"
#line 50
...
# 48 "/opt/tinyos/tos/lib/tossim/sim_packet.c"
...
# 25 "/opt/tinyos/tos/chips/atm128/sim/atm128_sim.h"
...
# 51 "/opt/tinyos/tos/chips/atm128/sim/atm128hardware.h"
...
# 43 "/opt/tinyos/tos/chips/atm128/adc/Atm128Adc.h"
...
# 54 "/opt/tinyos/tos/platforms/micaz/sim/platform_hardware.h"
...
# 41 "/opt/tinyos/tos/lib/tossim/SimMainP.nc"
...
enum AMQueueP$__nesc_unnamed4295 {
...
# 44 "/opt/tinyos/tos/lib/tossim/SimMote.nc"
...
uint8_t len);
# 85 "/opt/tinyos/tos/lib/tossim/TossimPacketModel.nc"
...
# 57 "/opt/tinyos/tos/lib/tossim/TossimPacketModel.nc"
...
# 60 "/opt/tinyos/tos/lib/tossim/GainRadioModel.nc"
...
# 60 "/opt/tinyos/tos/lib/tossim/ActiveMessageAddressC.nc"
...
static void BasicSimC$Boot$booted(void );
# 110 "/opt/tinyos/tos/interfaces/AMSend.nc"
static void BasicSimC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void BasicSimC$RadioControl$startDone(error_t error);
#line 138
static void BasicSimC$RadioControl$stopDone(error_t error);
# 78 "/opt/tinyos/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 80 "/opt/tinyos/tos/interfaces/AMSend.nc"
static error_t /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 51 "/opt/tinyos/tos/platforms/mica/PlatformP.nc"
...
# 49 "/opt/tinyos/tos/platforms/micaz/MotePlatformP.nc"
static inline error_t MotePlatformP$PlatformInit$init(void );
#line 61
static inline error_t MotePlatformP$SubInit$default$init(void );
# 59 "/opt/tinyos/tos/chips/atm128/pins/sim/HplAtm128GeneralIOPinP.nc"
static __inline void /*HplAtm128GeneralIOC.PortA.Bit4*/HplAtm128GeneralIOPinP$4$IO$clr(void );


static __inline void /*HplAtm128GeneralIOC.PortA.Bit4*/HplAtm128GeneralIOPinP$4$IO$makeInput(void );
# 21 "/opt/tinyos/tos/platforms/mica/sim/MeasureClockC.nc"
...
# 51 "/opt/tinyos/tos/lib/tossim/SimMainP.nc"
...
enum SimSchedulerBasicP$__nesc_unnamed4296 {
...
# 50 "/opt/tinyos/tos/lib/tossim/SimMoteP.nc"
...
void sim_mote_enqueue_boot_event(int mote)   ;
# 57 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
...
# 62 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
...
# 48 "/opt/tinyos/tos/lib/tossim/GainRadioModel.nc"
...
# 96 "/opt/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
...
# 58 "/opt/tinyos/tos/lib/tossim/CpmModelC.nc"
...
static inline void CpmModelC$free_receive_message(CpmModelC$receive_message_t *msg);
# 65 "/opt/tinyos/tos/lib/tossim/ActiveMessageAddressC.nc"
...
# 80 "/opt/tinyos/tos/interfaces/AMSend.nc"
static error_t BasicSimC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 104 "/opt/tinyos/tos/interfaces/SplitControl.nc"
static error_t BasicSimC$RadioControl$start(void );
...
uint8_t len);
# 16 "BasicSimC.nc"
message_t BasicSimC$packet[1000];
bool BasicSimC$sending[1000];

static inline void BasicSimC$Boot$booted(void );



static inline void BasicSimC$RadioControl$startDone(error_t err);
#line 40
static inline void BasicSimC$AMSend$sendDone(message_t *bufPtr, error_t error);




static inline message_t *BasicSimC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 65
static inline void BasicSimC$RadioControl$stopDone(error_t err);
# 110 "/opt/tinyos/tos/interfaces/AMSend.nc"
static void /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos/tos/interfaces/Send.nc"
static error_t /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos/tos/interfaces/AMSend.nc"
...
enum /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4300 {
#line 126
...
#line 57
#line 55
typedef struct /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4302 {
  message_t * msg;
...
# 78 "/opt/tinyos/tos/lib/tossim/heap.c"
static inline void init_heap(heap_t *heap)
#line 78
{
  heap->size = 0;
...
# 317 "/opt/tinyos/tos/lib/tossim/sim_log.c"
inline static int sim_log_eq(void *key1, void *key2)
#line 317
{
...
# 130 "/opt/tinyos/tos/lib/tossim/sim_noise.c"
inline static unsigned int sim_noise_hash(void *key)
#line 130
{
  char *pt = (char *)key;
...
# 64 "/opt/tinyos/tos/lib/tossim/SimMoteP.nc"
static inline bool SimMoteP$SimMote$isOn(void )
#line 64
{
...
# 172 "/opt/tinyos/tos/lib/tossim/sim_log.c"
static inline void sim_log_add_channel(char *name, FILE *file)
#line 172
{
...
# 161 "/opt/tinyos/tos/lib/tossim/sim_gain.c"
static inline gain_entry_t *sim_gain_allocate_link(int mote)
#line 161
{
...
# 55 "/opt/tinyos/tos/lib/tossim/randomlib.c"
static inline void RandomInitialise(int ij, int kl)
{
  double s;
#line 57
...
# 284 "/opt/tinyos/tos/lib/tossim/sim_noise.c"
static inline void sim_noise_alarm()
#line 284
{
  dummy = 5;
...
# 50 "/opt/tinyos/tos/lib/tossim/sim_packet.c"
inline static tossim_header_t *getHeader(message_t *msg)
#line 50
{
...
# 236 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$active_message_deliver_handle(sim_event_t *evt)
#line 236
{
...
# 88 "/opt/tinyos/tos/lib/tossim/ActiveMessageAddressC.nc"
static inline am_addr_t ActiveMessageAddressC$amAddress(void )
#line 88
{
...
# 80 "/opt/tinyos/tos/interfaces/AMSend.nc"
inline static error_t BasicSimC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 189 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void *TossimActiveMessageC$Packet$getPayload(message_t *msg, uint8_t len)
#line 189
{
  if (len <= 28) {
...
# 126 "/opt/tinyos/tos/interfaces/Packet.nc"
inline static void * BasicSimC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 45
{
  uint16_t hopcount = __nesc_ntoh_uint16(((radio_msg_t *)payload)->hopcount.nxdata);

  sim_log_debug(148U, "stdout", "Received packet with hopcount = [%d]\n", hopcount);



  if (!BasicSimC$sending[sim_node()]) {
      radio_msg_t *msgPayload = (radio_msg_t *)BasicSimC$Packet$getPayload(&BasicSimC$packet[sim_node()], sizeof(radio_msg_t ));

      __nesc_hton_uint16(msgPayload->hopcount.nxdata, hopcount + 1);

      if (BasicSimC$AMSend$send(AM_BROADCAST_ADDR, &BasicSimC$packet[sim_node()], sizeof(radio_msg_t )) == SUCCESS) {
          BasicSimC$sending[sim_node()] = TRUE;
        }
    }
...
# 212 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline message_t *TossimActiveMessageC$Receive$default$receive(am_id_t id, message_t *msg, void *payload, uint8_t len)
#line 212
{
  return msg;
...
# 78 "/opt/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x408e7ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x408e7ac8) {
#line 78
    case 6:
#line 78
      __nesc_result = BasicSimC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x408e7ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 65 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline tossim_header_t *TossimActiveMessageC$getHeader(message_t *amsg)
#line 65
{
...
# 103 "/opt/tinyos/tos/interfaces/AMPacket.nc"
inline static void /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
# 170 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$AMPacket$setType(message_t *amsg, am_id_t t)
#line 170
{
  tossim_header_t *header = TossimActiveMessageC$getHeader(amsg);
...
inline static void /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40a26490, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40a26490, addr, msg, len);
#line 80
...
#line 147
# 181 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$Packet$setPayloadLength(message_t *msg, uint8_t len)
#line 181
{
...
# 75 "/opt/tinyos/tos/interfaces/Send.nc"
inline static error_t /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 110 "/opt/tinyos/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x408e7108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x408e7108, msg, error);
#line 110
}
#line 110
# 103 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$Model$sendDone(message_t *msg, error_t result)
#line 103
{
...
# 76 "/opt/tinyos/tos/lib/tossim/TossimPacketModel.nc"
...
# 483 "/opt/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline void CpmModelC$free_receive_message(CpmModelC$receive_message_t *msg)
#line 483
{
  free(msg);
...
# 61 "/opt/tinyos/tos/lib/tossim/GainRadioModel.nc"
...
#line 85
# 288 "/opt/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$GainRadioModel$receive(message_t *msg)
#line 288
{
...
#line 60
# 260 "/opt/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline bool CpmModelC$checkReceive(CpmModelC$receive_message_t *msg)
#line 260
{
...
#line 48
# 280 "/opt/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$send_transmit_done(sim_event_t *evt)
#line 280
{
...
# 459 "/opt/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline void CpmModelC$Model$setPendingTransmission(void )
#line 459
{
...
# 57 "/opt/tinyos/tos/lib/tossim/GainRadioModel.nc"
...
#line 57
# 211 "/opt/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline bool CpmModelC$Model$clearChannel(void )
#line 211
{
...
# 56 "/opt/tinyos/tos/lib/tossim/GainRadioModel.nc"
...
#line 56
# 211 "/opt/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$send_backoff(sim_event_t *evt)
#line 211
{
...
#line 57
# 90 "/opt/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline double CpmModelC$timeInMs(void )
#line 90
{
...
# 177 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline uint8_t TossimActiveMessageC$Packet$payloadLength(message_t *msg)
#line 177
{
...
#line 67
# 139 "/opt/tinyos/tos/lib/tossim/SimSchedulerBasicP.nc"
static inline bool SimSchedulerBasicP$isWaiting(uint8_t id)
{
...
# 230 "/opt/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline double CpmModelC$prr_estimate_from_snr(double SNR)
#line 230
{
...
# 127 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline bool TossimActiveMessageC$Model$shouldAck(message_t *msg)
#line 127
{
...
# 87 "/opt/tinyos/tos/lib/tossim/TossimPacketModel.nc"
...
#line 87
# 296 "/opt/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$GainRadioModel$acked(message_t *msg)
#line 296
{
  if (TossimPacketModelC$running[sim_node()]) {
...
# 59 "/opt/tinyos/tos/lib/tossim/GainRadioModel.nc"
...
#line 59
# 151 "/opt/tinyos/tos/lib/tossim/CpmModelC.nc"
static inline double CpmModelC$arr_estimate_from_snr(double SNR)
#line 151
{
  double beta1 = 0.9794;
...
# 216 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline message_t *TossimActiveMessageC$Snoop$default$receive(am_id_t id, message_t *msg, void *payload, uint8_t len)
#line 216
{
  return msg;
...
# 78 "/opt/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x408e6178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x408e6178, msg, payload, len);
#line 78
...
#line 78
# 89 "/opt/tinyos/tos/chips/atm128/sim/atm128hardware.h"
static __inline void __nesc_disable_interrupt()
#line 89
{
...
# 85 "/opt/tinyos/tos/lib/tossim/SimSchedulerBasicP.nc"
static inline void SimSchedulerBasicP$sim_scheduler_event_handle(sim_event_t *e)
#line 85
{
...
#line 57
# 120 "/opt/tinyos/tos/lib/tossim/SimSchedulerBasicP.nc"
static inline uint8_t SimSchedulerBasicP$popTask(void )
{
  if (SimSchedulerBasicP$m_head[sim_node()] != SimSchedulerBasicP$NO_TASK) 
    {
...
# 104 "/opt/tinyos/tos/interfaces/SplitControl.nc"
inline static error_t BasicSimC$RadioControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
{
  if (err == SUCCESS) {
      if (TOS_NODE_ID == 0 && !BasicSimC$sending[sim_node()]) {
          radio_msg_t *msgPayload = (radio_msg_t *)BasicSimC$Packet$getPayload(&BasicSimC$packet[sim_node()], sizeof(radio_msg_t ));

          __nesc_hton_uint16(msgPayload->hopcount.nxdata, 0);
...
#line 113
  BasicSimC$RadioControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  BasicSimC$RadioControl$stopDone(error);
#line 138
}
#line 138
# 101 "/opt/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$stopDoneTask$runTask(void )
#line 101
{
...
#line 40
{
  if (&BasicSimC$packet[sim_node()] == bufPtr) {
    BasicSimC$sending[sim_node()] = FALSE;
    }
}

# 110 "/opt/tinyos/tos/interfaces/AMSend.nc"
inline static void /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  BasicSimC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40a2aa88, message_t * msg, error_t error){
#line 100
  switch (arg_0x40a2aa88) {
#line 100
    case 0U:
#line 100
      /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40a2aa88, msg, error);
#line 100
      break;
#line 100
    }
...
# 221 "/opt/tinyos/tos/lib/tossim/SimSchedulerBasicP.nc"
static inline void SimSchedulerBasicP$TaskBasic$default$runTask(uint8_t id)
{
}

# 75 "/opt/tinyos/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x4072d630){
#line 75
  switch (arg_0x4072d630) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x4072d630);
#line 75
      break;
#line 75
    }
...
#line 67
# 61 "/opt/tinyos/tos/platforms/micaz/MotePlatformP.nc"
static inline error_t MotePlatformP$SubInit$default$init(void )
#line 61
{
  return SUCCESS;
...
#line 41
# 62 "/opt/tinyos/tos/chips/atm128/pins/sim/HplAtm128GeneralIOPinP.nc"
static __inline void /*HplAtm128GeneralIOC.PortA.Bit4*/HplAtm128GeneralIOPinP$4$IO$makeInput(void )
#line 62
{
#line 62
...
#line 65
# 86 "/opt/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline error_t TossimPacketModelC$Init$init(void )
#line 86
{
...
#line 62
# 85 "/opt/tinyos/tos/chips/atm128/sim/atm128hardware.h"
static __inline void __nesc_enable_interrupt()
#line 85
{
  atm128RegFile[sim_node()][* (volatile uint8_t *)&atm128RegFile[sim_node()][0x3F]] |= 1 << 7;
...
#line 60
  BasicSimC$Boot$booted();
#line 60
}
#line 60
# 55 "/opt/tinyos/tos/lib/tossim/SimMoteP.nc"
static inline long long int SimMoteP$SimMote$getEuid(void )
#line 55
{
...
# 46 "/opt/tinyos/tos/lib/tossim/sim_event_queue.c"
  void sim_queue_init()
#line 46
{
  init_heap(&eventHeap);
...
# 246 "/opt/tinyos/tos/lib/tossim/sim_log.c"
static void sim_log_debug(uint16_t id, char *string, const char *format, ...)
#line 246
{
  va_list args;
...
# 121 "/opt/tinyos/tos/lib/tossim/sim_tossim.c"
  unsigned long sim_node()
#line 121
{
  return current_node;
...
# 197 "/opt/tinyos/tos/lib/tossim/heap.c"
static void up_heap(heap_t *heap, int findex)
#line 197
{
  int parent_index;
...
# 55 "/opt/tinyos/tos/lib/tossim/sim_event_queue.c"
  sim_event_t *sim_queue_pop()
#line 55
{
  long long int key;
...
# 114 "/opt/tinyos/tos/lib/tossim/heap.c"
static void *heap_pop_min_data(heap_t *heap, long long int *key)
#line 114
{
...
# 60 "/opt/tinyos/tos/lib/tossim/sim_event_queue.c"
  bool sim_queue_is_empty()
#line 60
{
...
# 57 "/opt/tinyos/tos/lib/tossim/sim_tossim.c"
  void sim_init()
#line 57
{
  sim_queue_init();
...
# 234 "/opt/tinyos/tos/lib/tossim/sim_log.c"
static void sim_log_commit_change()
#line 234
{
  int i;
...
# 67 "/opt/tinyos/tos/lib/tossim/sim_noise.c"
  void sim_noise_init()
{
  int j;
...
# 102 "/opt/tinyos/tos/lib/tossim/sim_tossim.c"
  void sim_random_seed(int seed)
#line 102
{
...
# 134 "/opt/tinyos/tos/lib/tossim/SimMoteP.nc"
  bool sim_mote_is_on(int mote)
#line 134
{
  bool result;
...
# 276 "/opt/tinyos/tos/lib/tossim/sim_log.c"
static void sim_log_debug_clear(uint16_t id, char *string, const char *format, ...)
#line 276
{
  va_list args;
...
# 156 "/opt/tinyos/tos/lib/tossim/sim_tossim.c"
  int sim_print_time(char *buf, int len, sim_time_t ftime)
#line 156
{
  int hours;
...
# 57 "/opt/tinyos/tos/lib/tossim/sim_csma.c"
  int sim_csma_init_high()
#line 57
{
  return csmaInitHigh;
...
# 16 "/opt/tinyos/tos/lib/tossim/sim_gain.c"
  gain_entry_t *sim_gain_first(int src)
#line 16
{
  if (src > 1000) {
...
# 84 "/opt/tinyos/tos/lib/tossim/sim_noise.c"
  void sim_noise_create_model(uint16_t node_id)
#line 84
{
...
# 103 "/opt/tinyos/tos/lib/tossim/randomlib.c"
static double RandomUniform(void )
{
  double uni;
  int seed1;
...
# 364 "/opt/tinyos/tos/lib/tossim/sim_noise.c"
  char sim_noise_generate(uint16_t node_id, uint32_t cur_t)
#line 364
{
  uint32_t i;
...
# 261 "/opt/tinyos/tos/lib/tossim/sim_log.c"
static void sim_log_error(uint16_t id, char *string, const char *format, ...)
#line 261
{
  va_list args;
...
# 54 "/opt/tinyos/tos/lib/tossim/sim_packet.c"
  void sim_packet_set_source(sim_packet_t *msg, uint16_t src)
#line 54
{
...
# 254 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
  void active_message_deliver(int node, message_t *msg, sim_time_t t)
#line 254
{
...
# 76 "/opt/tinyos/tos/lib/tossim/ActiveMessageAddressC.nc"
static am_addr_t ActiveMessageAddressC$ActiveMessageAddress$amAddress(void )
#line 76
{
...
# 165 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static am_id_t TossimActiveMessageC$AMPacket$type(message_t *amsg)
#line 165
{
  tossim_header_t *header = TossimActiveMessageC$getHeader(amsg);
...
#line 55
{
  /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*BasicSimAppC.Sender.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 73 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static error_t TossimActiveMessageC$AMSend$send(am_id_t id, am_addr_t addr, 
message_t *amsg, 
uint8_t len)
#line 75
...
# 274 "/opt/tinyos/tos/lib/tossim/CpmModelC.nc"
static double CpmModelC$packetNoise(CpmModelC$receive_message_t *msg)
#line 274
{
  double noise = CpmModelC$noise_hash_generation();
...
# 205 "/opt/tinyos/tos/lib/tossim/SimSchedulerBasicP.nc"
static error_t SimSchedulerBasicP$TaskBasic$postTask(uint8_t id)
{
  error_t result;
...
# 248 "/opt/tinyos/tos/lib/tossim/CpmModelC.nc"
static bool CpmModelC$shouldReceive(double SNR)
#line 248
{
...
# 307 "/opt/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static bool TossimPacketModelC$GainRadioModel$shouldAck(message_t *msg)
#line 307
{
  if (TossimPacketModelC$running[sim_node()] && !TossimPacketModelC$transmitting[sim_node()]) {
...
# 216 "/opt/tinyos/tos/lib/tossim/CpmModelC.nc"
static void CpmModelC$sim_gain_schedule_ack(int source, sim_time_t t, CpmModelC$receive_message_t *r)
#line 216
{
...
# 110 "/opt/tinyos/tos/lib/tossim/sim_packet.c"
  uint8_t sim_packet_max_length(sim_packet_t *msg)
#line 110
{
  return 28;
...
# 180 "/opt/tinyos/tos/lib/tossim/SimSchedulerBasicP.nc"
static bool SimSchedulerBasicP$Scheduler$runNextTask(void )
{
  uint8_t nextTask;
...
# 106 "/opt/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static error_t TossimPacketModelC$Control$start(void )
#line 106
{
  if (!TossimPacketModelC$initialized[sim_node()]) {
...
# 90 "/opt/tinyos/tos/lib/tossim/SimMoteP.nc"
  long long int sim_mote_euid(int mote)
#line 90
{
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module BasicSimC */
  if (!strcmp(varname, "BasicSimC$packet"))
  {
    *addr = (uintptr_t)&BasicSimC$packet[__nesc_mote];
    *size = sizeof(BasicSimC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "BasicSimC$sending"))
  {
    *addr = (uintptr_t)&BasicSimC$sending[__nesc_mote];
    *size = sizeof(BasicSimC$sending[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module BasicSimC */
  memset((void *)&BasicSimC$packet[__nesc_mote], 0, sizeof BasicSimC$packet[__nesc_mote]);
  memset((void *)&BasicSimC$sending[__nesc_mote], 0, sizeof BasicSimC$sending[__nesc_mote]);
