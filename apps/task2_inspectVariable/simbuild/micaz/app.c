...
static void InspectVariableC$Boot$booted(void );
# 62 "/opt/tinyos/tos/interfaces/Init.nc"
...
# 63 "/opt/tinyos/tos/lib/tossim/CpmModelC.nc"
...
# 9 "InspectVariableC.nc"
uint8_t InspectVariableC$counter[1000];

static inline void InspectVariableC$Boot$booted(void );
...
# 69 "/opt/tinyos/tos/lib/tossim/SimSchedulerBasicP.nc"
static inline int SimSchedulerBasicP$sim_config_task_latency(void )
#line 69
{
#line 69
...
# 316 "/opt/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline void TossimPacketModelC$Control$default$startDone(error_t err)
#line 316
{
  return;
...
# 220 "/opt/tinyos/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$AMSend$default$sendDone(uint8_t id, message_t *msg, error_t err)
#line 220
{
  return;
...
#line 110
    TossimActiveMessageC$AMSend$default$sendDone(arg_0x408e7108, msg, error);
#line 110
}
#line 110
...
#line 76
# 82 "/opt/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
static inline tossim_metadata_t *TossimPacketModelC$getMetadata(message_t *msg)
#line 82
{
...
# 11 "InspectVariableC.nc"
static inline void InspectVariableC$Boot$booted(void )
{
  InspectVariableC$counter[sim_node()] = TOS_NODE_ID * 10;
}

# 60 "/opt/tinyos/tos/interfaces/Boot.nc"
inline static void SimMainP$Boot$booted(void ){
#line 60
  InspectVariableC$Boot$booted();
#line 60
}
#line 60
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "InspectVariableC$counter"))
  {
    *addr = (uintptr_t)&InspectVariableC$counter[__nesc_mote];
    *size = sizeof(InspectVariableC$counter[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module InspectVariableC */
  memset((void *)&InspectVariableC$counter[__nesc_mote], 0, sizeof InspectVariableC$counter[__nesc_mote]);
